...
let endpoint = wsStart + locations.host + '/ws' + locations.pathname
console.log(endpoint)
// adding the messages to the message body 
let input_message = $('#input-message')
let message_body = $('.msg_card_body')
// for getting the loged in user id
...
function newMessage(message,send_by_id) {
    ...
    console.log('usersssssss id',send_by_id,'   loged in user ', USER_ID)
	if ($.trim(message) === '') {
		return false;
	}
	let message_element;
